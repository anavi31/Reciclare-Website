...
with col1:
    ...
    st.markdown(
        '<p class="instruction">Nós enviamos um código de 4 dígitos para o endereço de e-mail: <strong>joao9554@gmail.com</strong>.</p>',
        unsafe_allow_html=True,
    )

    # Campos de entrada para os 4 dígitos com suporte a foco automático
    st.markdown(
        """
